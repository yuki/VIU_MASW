...
Es importante acordarse que hemos modificado el fichero \configfile{/etc/hosts}, por lo que ahora deberemos reflejar la nueva IP para poder acceder al dominio de la aplicación.
