...
Esto se controla a la hora de dibujar la primera columna en la vista,  con la directiva \textbf{*ngIf}: \inlineconsole{<td class="col-1" *ngIf="plataforma_id==0">}, que sólo pondrá la columna si “plataforma\_id” es cero (vista principal).
