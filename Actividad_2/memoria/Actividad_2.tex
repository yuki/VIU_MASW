...
\end{mycode}
    ...
    \item Junto con el código anterior, se indica que el resultado obtenido se va a parsear para obtener una lista de objetos “Movie”, que está especificado dentro del fichero \configfile{dataclass/Movie.kt}. En este fichero se indica cómo es la clase y los distintos atributos que contiene.
...
\begin{itemize}
    ...
    \item La \textbf{estructura de los datos} está dentro del fichero de configuración \configfile{proto/movie.proto}. Este fichero sería el equivalente a un “\textit{schema}” de creación de una tabla en MySQL.
...
\begin{center}
    \includegraphics[width=0.4\linewidth]{img/list.png}
\end{center}
...
\begin{center}
    \includegraphics[width=0.4\linewidth]{img/movie.png}
\end{center}
