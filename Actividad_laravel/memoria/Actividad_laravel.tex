...
Para mostrar este mensaje se ha creado un template en \configfile{resources/views/layouts/_errors.blade.php} que genera un listado con todos los errores, como aparece en la imagen.
