...
Para mostrar este mensaje, y los del registro, se ha creado un template en \configfile{resources/views/layouts/_errors.blade.php} que genera un listado con todos los errores, como aparece en la imagen.
...
De cara a futuro, se podría mejorar creando unas variables de entorno en el fichero \configfile{.env} donde se indique el la dificultad de la contraseña a introducir.
